...
\title{\textbf{CASSA: A Scalable Communication-Aware Swarm Safety Architecture for Aerial Robot Navigation}}
\author{}
\date{}
...
This paper contributes a reproducible simulation-based safety-architecture study of large-scale aerial swarm navigation under degraded nominal communication. The proposed architecture, CASSA, separates communication-based nominal coordination from a modeled short-range local relative-state safety abstraction, then enforces obstacle clearance at the command level through acceleration-bounded braking before state integration. The evaluation uses swarms of 50 to 1000 agents in open flocking, obstacle corridor, crossing traffic, and merge--split scenarios. Baselines include boids, artificial potential fields, a short-horizon predictive surrogate, a MADER-inspired surrogate, and external-package CBF-QP and RVO2 rows. The main contributions are:
...
\input{tables/table_0_information_streams.tex}
...
\input{tables/table_5_parameter_summary.tex}
...
\input{tables/table_1_controller_comparison.tex}
...
\input{tables/table_2_proposed_by_scenario.tex}
...
\input{tables/table_6_projection_audit.tex}
...
\input{tables/table_9_crazyflow_replay.tex}
